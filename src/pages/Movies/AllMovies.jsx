      ...
      <>
        <section>
          <div
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-gray-800 to-black opacity-15"></div>

            <div className="relative z-10 text-center text-white mt-[5rem]">
              <h1 className="text-8xl font-bold mb-4">Movie_Mehfil</h1>
            ...
            <section className="absolute -bottom-[5rem]">
              ...
              <section className="sorts-container mt-[2rem] ml-[10rem]  w-[30rem]">
                <select
                  className="border p-2 rounded text-bold text-black"
                  value={moviesFilter.selectedGenre}
                  onChange={(e) => handleGenreClick(e.target.value)}
                >
                  <option value="text-bold">GENRES</option>
                  {genres?.map((genre) => (
